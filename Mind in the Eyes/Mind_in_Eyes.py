...
#Output Directory and File Checking:
...
run_param_list = []
header = ['Trial','TrialStart','Stimulus','StimGender','Accuracy','RT','SubResponse','CorrectResponse','Responses','TrialEnd']

#Define text/visual stimuli and location 
text = visual.TextStim(win, text = '', pos = (0,0), height = 0.06, color='Black', wrapWidth = 1.3) 
image = visual.ImageStim(win = win, pos = (0,0), size = (1.0,1.0), image = stim_df["Stimulus"][0])
coordinates = [(-0.4,0.6),(0.4,0.6),(-0.4,-0.6),(0.4,-0.6)]

#Instruction Page:
text.text = '\t\t\tFor each set of eyes, indicate which word best describes\n\t\t\twhat the person in the picture is thinking or feeling.\n\n\n1 = Top Left     ||     2 = Top Right     ||     3 = Bottom Left     ||     4 = Bottom Right \n\n\nYou may feel that more than one word is applicable but please choose\n\tjust one word, the word which you consider to be most suitable.\nBefore making your choice, make sure that you have read all 4 words.\nYou should try to do the task as quickly as possible but you will not be timed.\n\n\t\t\t\t\t\tPress any key to begin'
text.draw()
win.flip()
while True:
