...
#Create GUI:
expName = "CMNT"
expInfo = {"participant ID": "", "run": ""} #Condition Files: F1, F2, M1, M2
...
promptNames = ["Mia","Sam","Ben",'Ann','Sue']
newName = partner["PromptName"][0]
conditionFile = partner["Condition"][0]
trial_times_order = partner['TrialTimes'][0]
...
if expInfo["run"] == '1':
    ...
    order = pd.read_csv("CMNTorder_%s.csv" %trial_times_order, header=None)
